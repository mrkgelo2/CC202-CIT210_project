                ...
                <div class="col-md-12 grid-margin">
                     <div class="row">
                        <div class="col-12 col-xl-10 mb-4 mb-xl-0">
                         <h3 class="font-weight-bold">Blotter/Incident Reports</h3>
                        </div>
                        <div class="col-12 col-xl-2 mb-4 mb-xl-0 text-right">
                             <button class="btn btn-primary" id="addBlotterBtn">Add Blotter</button>
                        </div>
                     </div>
                </div>
                <div class="card">
                  <?php require("forms/addblotterrep.php") ?>
                </div>
